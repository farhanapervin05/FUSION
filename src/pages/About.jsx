  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: '1.1rem', marginBottom: '1.5rem', color: '#444', textAlign: 'center' }}>
        Welcome to the tastiest chaos on the internet — where culinary traditions meet code and give birth to wild, delicious ideas. 
      ...
      <p>
        Created by a student with equal passion for design, food, and coding. This is part of a Semester 2 web project — built with late nights, low patience, but high ambition.
      </p>

      <h2 style={{ fontSize: '1.3rem', marginTop: '2rem' }}>Let’s Connect?</h2>
      <p>
