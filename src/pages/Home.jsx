...
export default function Home() {
  return (
    <div style={{ maxWidth: 900, margin: '2rem auto', padding: '0 1rem', fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      ...
      <h2 style={{ marginTop: '3rem', marginBottom: '1rem', borderBottom: '2px solid #222', paddingBottom: '0.3rem' }}>Popular Fusions</h2>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
        {fusions.map(({ name, desc, tip }) => (
          <div key={name} style={{ padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
